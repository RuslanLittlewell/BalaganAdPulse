...
import { computeTable, type TableProperty, type TableRecord } from "../../src/modules/campaigns/index.js";
import type { Expression } from "../../src/modules/campaigns/presentation/http/campaign-schemas.js";
  ...
  return {
    ...
    storedValues: [
      ...Object.entries(values).map(([propertyId, value]) => ({
        propertyId,
        numberValue: value === null ? null : new Decimal(value),
        textValue: null,
      })),
