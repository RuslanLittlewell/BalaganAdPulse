...
import { writeTokens } from "@/shared/lib/index.js";
import { makeAccessToken } from "@test/shared/index.js";
import { RequireAuth } from "@/features/auth/model/RequireAuth.js";
...
describe("RequireAuth", () => {
  ...
  it("renders the page when the server session marker is present", () => {
