...
export function EditableCell({
  ...
  if (editing) {
    return (
      <span className={"relative inline-grid w-full"}>
        ...
        <span className={"invisible col-start-1 row-start-1 whitespace-pre px-3 py-2"} aria-hidden="true">
          {pending ?? display}
        </span>
        <Input
          ref={inputRef}
          className="col-start-1 row-start-1 h-auto min-w-0 px-3 py-2"
  ...
  return (
    <Button
      ref={buttonRef}
      variant="ghost"
      className="h-auto min-h-10 w-full justify-start rounded-none px-3 py-2 text-sm font-normal"
